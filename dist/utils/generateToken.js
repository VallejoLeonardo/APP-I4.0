...
export const generateAccessToken = (userId) => {
    if (!process.env.JWT_SECRET) {
        console.error("🚨 SECURITY WARNING: JWT_SECRET not set in environment variables. Using generated secret for this session only.");
        console.error("🔧 Please set JWT_SECRET in your .env file for production use.");
